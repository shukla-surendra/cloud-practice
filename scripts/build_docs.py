...
<section class="hero">
  <h1>{site}</h1>
  <p class="hero-sub">Architecture &amp; internals deep-dives across <strong>AWS</strong>
  and <strong>GCP</strong> &mdash; why each service exists, how it's built inside,
  networking, storage, security, and production patterns.</p>
